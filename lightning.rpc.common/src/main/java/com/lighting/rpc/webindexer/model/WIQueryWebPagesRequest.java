...
public class WIQueryWebPagesRequest implements org.apache.thrift.TBase<WIQueryWebPagesRequest, WIQueryWebPagesRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WIQueryWebPagesRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new WIQueryWebPagesRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WIQueryWebPagesRequestTupleSchemeFactory());
  }
   ...
   * @see WIHighLightType
   */
  public WIHighLightType hightlight; // required
  /**
   * 
   * @see WIQueryDivideType
   */
  public WIQueryDivideType divideType; // required
  ...
  private static final int __SUMMARYLENGTH_ISSET_ID = 3;
  ...
  static {
    ...
    tmpMap.put(_Fields.HIGHTLIGHT, new org.apache.thrift.meta_data.FieldMetaData("hightlight", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, WIHighLightType.class)));
    tmpMap.put(_Fields.DIVIDE_TYPE, new org.apache.thrift.meta_data.FieldMetaData("divideType", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, WIQueryDivideType.class)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WIQueryWebPagesRequest.class, metaDataMap);
  }

  public WIQueryWebPagesRequest() {
    this.pageno = 0;
    ...
    this.hightlight = com.lighting.rpc.webindexer.model.WIHighLightType.WI_HIGHLIGHT_ON;

    this.divideType = com.lighting.rpc.webindexer.model.WIQueryDivideType.WI_QUERY_DIVIDE_ON;
  ...
  public WIQueryWebPagesRequest(
    ...
    int pagesize,
    int summaryLength,
    WIHighLightType hightlight,
    WIQueryDivideType divideType)
  {
    this();
    this.logid = logid;
    setLogidIsSet(true);
   ...
   */
  public WIQueryWebPagesRequest(WIQueryWebPagesRequest other) {
  ...
  public WIQueryWebPagesRequest deepCopy() {
    return new WIQueryWebPagesRequest(this);
  }
  ...
  public WIQueryWebPagesRequest setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public WIQueryWebPagesRequest setQuery(String query) {
    this.query = query;
    return this;
  }
  ...
  public WIQueryWebPagesRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public WIQueryWebPagesRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public WIQueryWebPagesRequest setSummaryLength(int summaryLength) {
    this.summaryLength = summaryLength;
    setSummaryLengthIsSet(true);
    return this;
  }
   ...
   * @see WIHighLightType
   */
  public WIHighLightType getHightlight() {
   ...
   * @see WIHighLightType
   */
  public WIQueryWebPagesRequest setHightlight(WIHighLightType hightlight) {
    this.hightlight = hightlight;
    return this;
  }
   ...
   * @see WIQueryDivideType
   */
  public WIQueryDivideType getDivideType() {
   ...
   * @see WIQueryDivideType
   */
  public WIQueryWebPagesRequest setDivideType(WIQueryDivideType divideType) {
    this.divideType = divideType;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HIGHTLIGHT:
      if (value == null) {
        ...
        setHightlight((WIHighLightType)value);
      }
      break;
    ...
    case DIVIDE_TYPE:
      if (value == null) {
        ...
        setDivideType((WIQueryDivideType)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WIQueryWebPagesRequest)
      return this.equals((WIQueryWebPagesRequest)that);
    return false;
  }

  public boolean equals(WIQueryWebPagesRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(WIQueryWebPagesRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    WIQueryWebPagesRequest typedOther = (WIQueryWebPagesRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WIQueryWebPagesRequest(");
    boolean first = true;
  ...
  private static class WIQueryWebPagesRequestStandardSchemeFactory implements SchemeFactory {
    public WIQueryWebPagesRequestStandardScheme getScheme() {
      return new WIQueryWebPagesRequestStandardScheme();
    }
  }

  private static class WIQueryWebPagesRequestStandardScheme extends StandardScheme<WIQueryWebPagesRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WIQueryWebPagesRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // HIGHTLIGHT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.hightlight = WIHighLightType.findByValue(iprot.readI32());
          ...
          case 7: // DIVIDE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.divideType = WIQueryDivideType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WIQueryWebPagesRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class WIQueryWebPagesRequestTupleSchemeFactory implements SchemeFactory {
    public WIQueryWebPagesRequestTupleScheme getScheme() {
      return new WIQueryWebPagesRequestTupleScheme();
    }
  }

  private static class WIQueryWebPagesRequestTupleScheme extends TupleScheme<WIQueryWebPagesRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WIQueryWebPagesRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WIQueryWebPagesRequest struct) throws org.apache.thrift.TException {
