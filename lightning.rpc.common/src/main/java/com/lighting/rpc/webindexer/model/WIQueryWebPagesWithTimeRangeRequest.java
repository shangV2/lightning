...
public class WIQueryWebPagesWithTimeRangeRequest implements org.apache.thrift.TBase<WIQueryWebPagesWithTimeRangeRequest, WIQueryWebPagesWithTimeRangeRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WIQueryWebPagesWithTimeRangeRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new WIQueryWebPagesWithTimeRangeRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WIQueryWebPagesWithTimeRangeRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WIQueryWebPagesWithTimeRangeRequest.class, metaDataMap);
  }

  public WIQueryWebPagesWithTimeRangeRequest() {
    this.pageno = 0;
   ...
   */
  public WIQueryWebPagesWithTimeRangeRequest(WIQueryWebPagesWithTimeRangeRequest other) {
  ...
  public WIQueryWebPagesWithTimeRangeRequest deepCopy() {
    return new WIQueryWebPagesWithTimeRangeRequest(this);
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setQuery(String query) {
    this.query = query;
    return this;
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setStartDate(String startDate) {
    this.startDate = startDate;
    return this;
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setEndDate(String endDate) {
    this.endDate = endDate;
    return this;
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public WIQueryWebPagesWithTimeRangeRequest setSummaryLength(int summaryLength) {
    this.summaryLength = summaryLength;
    setSummaryLengthIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WIQueryWebPagesWithTimeRangeRequest)
      return this.equals((WIQueryWebPagesWithTimeRangeRequest)that);
    return false;
  }

  public boolean equals(WIQueryWebPagesWithTimeRangeRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(WIQueryWebPagesWithTimeRangeRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    WIQueryWebPagesWithTimeRangeRequest typedOther = (WIQueryWebPagesWithTimeRangeRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WIQueryWebPagesWithTimeRangeRequest(");
    boolean first = true;
  ...
  private static class WIQueryWebPagesWithTimeRangeRequestStandardSchemeFactory implements SchemeFactory {
    public WIQueryWebPagesWithTimeRangeRequestStandardScheme getScheme() {
      return new WIQueryWebPagesWithTimeRangeRequestStandardScheme();
    }
  }

  private static class WIQueryWebPagesWithTimeRangeRequestStandardScheme extends StandardScheme<WIQueryWebPagesWithTimeRangeRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WIQueryWebPagesWithTimeRangeRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WIQueryWebPagesWithTimeRangeRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class WIQueryWebPagesWithTimeRangeRequestTupleSchemeFactory implements SchemeFactory {
    public WIQueryWebPagesWithTimeRangeRequestTupleScheme getScheme() {
      return new WIQueryWebPagesWithTimeRangeRequestTupleScheme();
    }
  }

  private static class WIQueryWebPagesWithTimeRangeRequestTupleScheme extends TupleScheme<WIQueryWebPagesWithTimeRangeRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WIQueryWebPagesWithTimeRangeRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WIQueryWebPagesWithTimeRangeRequest struct) throws org.apache.thrift.TException {
