...
public class DCCreateTopicRequest implements org.apache.thrift.TBase<DCCreateTopicRequest, DCCreateTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DCCreateTopicRequest");
  ...
  private static final org.apache.thrift.protocol.TField TOPIC_FIELD_DESC = new org.apache.thrift.protocol.TField("topic", org.apache.thrift.protocol.TType.STRUCT, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new DCCreateTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DCCreateTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DCCreateTopicRequest.class, metaDataMap);
  }

  public DCCreateTopicRequest() {
   ...
   */
  public DCCreateTopicRequest(DCCreateTopicRequest other) {
  ...
  public DCCreateTopicRequest deepCopy() {
    return new DCCreateTopicRequest(this);
  }
  ...
  public DCCreateTopicRequest setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
   ...
   * @see DCCommonLanguge
   */
  public DCCreateTopicRequest setLangugeType(DCCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public DCCreateTopicRequest setTopic(DCConsistentTopic topic) {
    this.topic = topic;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DCCreateTopicRequest)
      return this.equals((DCCreateTopicRequest)that);
    return false;
  }

  public boolean equals(DCCreateTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(DCCreateTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    DCCreateTopicRequest typedOther = (DCCreateTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DCCreateTopicRequest(");
    boolean first = true;
  ...
  private static class DCCreateTopicRequestStandardSchemeFactory implements SchemeFactory {
    public DCCreateTopicRequestStandardScheme getScheme() {
      return new DCCreateTopicRequestStandardScheme();
    }
  }

  private static class DCCreateTopicRequestStandardScheme extends StandardScheme<DCCreateTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DCCreateTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DCCreateTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DCCreateTopicRequestTupleSchemeFactory implements SchemeFactory {
    public DCCreateTopicRequestTupleScheme getScheme() {
      return new DCCreateTopicRequestTupleScheme();
    }
  }

  private static class DCCreateTopicRequestTupleScheme extends TupleScheme<DCCreateTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DCCreateTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DCCreateTopicRequest struct) throws org.apache.thrift.TException {
