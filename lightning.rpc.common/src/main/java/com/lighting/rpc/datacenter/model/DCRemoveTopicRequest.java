...
public class DCRemoveTopicRequest implements org.apache.thrift.TBase<DCRemoveTopicRequest, DCRemoveTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DCRemoveTopicRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new DCRemoveTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DCRemoveTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DCRemoveTopicRequest.class, metaDataMap);
  }

  public DCRemoveTopicRequest() {
   ...
   */
  public DCRemoveTopicRequest(DCRemoveTopicRequest other) {
  ...
  public DCRemoveTopicRequest deepCopy() {
    return new DCRemoveTopicRequest(this);
  }
  ...
  public DCRemoveTopicRequest setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
   ...
   * @see DCCommonLanguge
   */
  public DCRemoveTopicRequest setLangugeType(DCCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public DCRemoveTopicRequest setTopicId(long topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DCRemoveTopicRequest)
      return this.equals((DCRemoveTopicRequest)that);
    return false;
  }

  public boolean equals(DCRemoveTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(DCRemoveTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    DCRemoveTopicRequest typedOther = (DCRemoveTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DCRemoveTopicRequest(");
    boolean first = true;
  ...
  private static class DCRemoveTopicRequestStandardSchemeFactory implements SchemeFactory {
    public DCRemoveTopicRequestStandardScheme getScheme() {
      return new DCRemoveTopicRequestStandardScheme();
    }
  }

  private static class DCRemoveTopicRequestStandardScheme extends StandardScheme<DCRemoveTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DCRemoveTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DCRemoveTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DCRemoveTopicRequestTupleSchemeFactory implements SchemeFactory {
    public DCRemoveTopicRequestTupleScheme getScheme() {
      return new DCRemoveTopicRequestTupleScheme();
    }
  }

  private static class DCRemoveTopicRequestTupleScheme extends TupleScheme<DCRemoveTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DCRemoveTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DCRemoveTopicRequest struct) throws org.apache.thrift.TException {
