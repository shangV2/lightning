...
public class WIQueryRequest implements org.apache.thrift.TBase<WIQueryRequest, WIQueryRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WIQueryRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new WIQueryRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WIQueryRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WIQueryRequest.class, metaDataMap);
  }

  public WIQueryRequest() {
    this.pageno = 0;
   ...
   */
  public WIQueryRequest(WIQueryRequest other) {
  ...
  public WIQueryRequest deepCopy() {
    return new WIQueryRequest(this);
  }
  ...
  public WIQueryRequest setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public WIQueryRequest setQuery(String query) {
    this.query = query;
    return this;
  }
  ...
  public WIQueryRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public WIQueryRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof WIQueryRequest)
      return this.equals((WIQueryRequest)that);
    return false;
  }

  public boolean equals(WIQueryRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(WIQueryRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    WIQueryRequest typedOther = (WIQueryRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("WIQueryRequest(");
    boolean first = true;
  ...
  private static class WIQueryRequestStandardSchemeFactory implements SchemeFactory {
    public WIQueryRequestStandardScheme getScheme() {
      return new WIQueryRequestStandardScheme();
    }
  }

  private static class WIQueryRequestStandardScheme extends StandardScheme<WIQueryRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WIQueryRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WIQueryRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class WIQueryRequestTupleSchemeFactory implements SchemeFactory {
    public WIQueryRequestTupleScheme getScheme() {
      return new WIQueryRequestTupleScheme();
    }
  }

  private static class WIQueryRequestTupleScheme extends TupleScheme<WIQueryRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WIQueryRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WIQueryRequest struct) throws org.apache.thrift.TException {
