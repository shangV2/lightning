...
public class DCTimeWordInfo implements org.apache.thrift.TBase<DCTimeWordInfo, DCTimeWordInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DCTimeWordInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new DCTimeWordInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DCTimeWordInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DCTimeWordInfo.class, metaDataMap);
  }

  public DCTimeWordInfo() {
  }
   ...
   */
  public DCTimeWordInfo(DCTimeWordInfo other) {
  ...
  public DCTimeWordInfo deepCopy() {
    return new DCTimeWordInfo(this);
  }
  ...
  public DCTimeWordInfo setWord(String word) {
    this.word = word;
    return this;
  }
  ...
  public DCTimeWordInfo setFreq(int freq) {
    this.freq = freq;
    setFreqIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DCTimeWordInfo)
      return this.equals((DCTimeWordInfo)that);
    return false;
  }

  public boolean equals(DCTimeWordInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(DCTimeWordInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    DCTimeWordInfo typedOther = (DCTimeWordInfo)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DCTimeWordInfo(");
    boolean first = true;
  ...
  private static class DCTimeWordInfoStandardSchemeFactory implements SchemeFactory {
    public DCTimeWordInfoStandardScheme getScheme() {
      return new DCTimeWordInfoStandardScheme();
    }
  }

  private static class DCTimeWordInfoStandardScheme extends StandardScheme<DCTimeWordInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DCTimeWordInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DCTimeWordInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DCTimeWordInfoTupleSchemeFactory implements SchemeFactory {
    public DCTimeWordInfoTupleScheme getScheme() {
      return new DCTimeWordInfoTupleScheme();
    }
  }

  private static class DCTimeWordInfoTupleScheme extends TupleScheme<DCTimeWordInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DCTimeWordInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DCTimeWordInfo struct) throws org.apache.thrift.TException {
