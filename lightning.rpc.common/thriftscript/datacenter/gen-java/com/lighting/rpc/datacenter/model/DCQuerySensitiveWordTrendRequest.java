...
public class DCQuerySensitiveWordTrendRequest implements org.apache.thrift.TBase<DCQuerySensitiveWordTrendRequest, DCQuerySensitiveWordTrendRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DCQuerySensitiveWordTrendRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new DCQuerySensitiveWordTrendRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DCQuerySensitiveWordTrendRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DCQuerySensitiveWordTrendRequest.class, metaDataMap);
  }

  public DCQuerySensitiveWordTrendRequest() {
   ...
   */
  public DCQuerySensitiveWordTrendRequest(DCQuerySensitiveWordTrendRequest other) {
  ...
  public DCQuerySensitiveWordTrendRequest deepCopy() {
    return new DCQuerySensitiveWordTrendRequest(this);
  }
  ...
  public DCQuerySensitiveWordTrendRequest setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
   ...
   * @see DCCommonLanguge
   */
  public DCQuerySensitiveWordTrendRequest setLangugeType(DCCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public DCQuerySensitiveWordTrendRequest setWord(String word) {
    this.word = word;
    return this;
  }
  ...
  public DCQuerySensitiveWordTrendRequest setStartDate(String startDate) {
    this.startDate = startDate;
    return this;
  }
  ...
  public DCQuerySensitiveWordTrendRequest setEndDate(String endDate) {
    this.endDate = endDate;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DCQuerySensitiveWordTrendRequest)
      return this.equals((DCQuerySensitiveWordTrendRequest)that);
    return false;
  }

  public boolean equals(DCQuerySensitiveWordTrendRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(DCQuerySensitiveWordTrendRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    DCQuerySensitiveWordTrendRequest typedOther = (DCQuerySensitiveWordTrendRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DCQuerySensitiveWordTrendRequest(");
    boolean first = true;
  ...
  private static class DCQuerySensitiveWordTrendRequestStandardSchemeFactory implements SchemeFactory {
    public DCQuerySensitiveWordTrendRequestStandardScheme getScheme() {
      return new DCQuerySensitiveWordTrendRequestStandardScheme();
    }
  }

  private static class DCQuerySensitiveWordTrendRequestStandardScheme extends StandardScheme<DCQuerySensitiveWordTrendRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DCQuerySensitiveWordTrendRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DCQuerySensitiveWordTrendRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DCQuerySensitiveWordTrendRequestTupleSchemeFactory implements SchemeFactory {
    public DCQuerySensitiveWordTrendRequestTupleScheme getScheme() {
      return new DCQuerySensitiveWordTrendRequestTupleScheme();
    }
  }

  private static class DCQuerySensitiveWordTrendRequestTupleScheme extends TupleScheme<DCQuerySensitiveWordTrendRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DCQuerySensitiveWordTrendRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DCQuerySensitiveWordTrendRequest struct) throws org.apache.thrift.TException {
