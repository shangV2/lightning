...
public class QueryOpenWebPageContentResponse implements org.apache.thrift.TBase<QueryOpenWebPageContentResponse, QueryOpenWebPageContentResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryOpenWebPageContentResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryOpenWebPageContentResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryOpenWebPageContentResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryOpenWebPageContentResponse.class, metaDataMap);
  }

  public QueryOpenWebPageContentResponse() {
    this.logid = 1001L;
   ...
   */
  public QueryOpenWebPageContentResponse(QueryOpenWebPageContentResponse other) {
  ...
  public QueryOpenWebPageContentResponse deepCopy() {
    return new QueryOpenWebPageContentResponse(this);
  }
  ...
  public QueryOpenWebPageContentResponse setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public QueryOpenWebPageContentResponse setTotalNum(int totalNum) {
    this.totalNum = totalNum;
    setTotalNumIsSet(true);
    return this;
  }
  ...
  public QueryOpenWebPageContentResponse setWebpages(List<OpenWebPageContent> webpages) {
    this.webpages = webpages;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryOpenWebPageContentResponse)
      return this.equals((QueryOpenWebPageContentResponse)that);
    return false;
  }

  public boolean equals(QueryOpenWebPageContentResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryOpenWebPageContentResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryOpenWebPageContentResponse typedOther = (QueryOpenWebPageContentResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryOpenWebPageContentResponse(");
    boolean first = true;
  ...
  private static class QueryOpenWebPageContentResponseStandardSchemeFactory implements SchemeFactory {
    public QueryOpenWebPageContentResponseStandardScheme getScheme() {
      return new QueryOpenWebPageContentResponseStandardScheme();
    }
  }

  private static class QueryOpenWebPageContentResponseStandardScheme extends StandardScheme<QueryOpenWebPageContentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryOpenWebPageContentResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.webpages = new ArrayList<OpenWebPageContent>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  OpenWebPageContent _elem18; // required
                  _elem18 = new OpenWebPageContent();
                  _elem18.read(iprot);
                  struct.webpages.add(_elem18);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryOpenWebPageContentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.webpages != null) {
        oprot.writeFieldBegin(WEBPAGES_FIELD_DESC);
        {
          ...
          for (OpenWebPageContent _iter19 : struct.webpages)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class QueryOpenWebPageContentResponseTupleSchemeFactory implements SchemeFactory {
    public QueryOpenWebPageContentResponseTupleScheme getScheme() {
      return new QueryOpenWebPageContentResponseTupleScheme();
    }
  }

  private static class QueryOpenWebPageContentResponseTupleScheme extends TupleScheme<QueryOpenWebPageContentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryOpenWebPageContentResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetWebpages()) {
        {
          ...
          for (OpenWebPageContent _iter20 : struct.webpages)
          {
            _iter20.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryOpenWebPageContentResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.webpages = new ArrayList<OpenWebPageContent>(_list21.size);
          for (int _i22 = 0; _i22 < _list21.size; ++_i22)
          {
            OpenWebPageContent _elem23; // required
            _elem23 = new OpenWebPageContent();
            _elem23.read(iprot);
            struct.webpages.add(_elem23);
          }
        }
        struct.setWebpagesIsSet(true);
      }
