...
public class QueryHotWebPageByEventResponse implements org.apache.thrift.TBase<QueryHotWebPageByEventResponse, QueryHotWebPageByEventResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryHotWebPageByEventResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryHotWebPageByEventResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryHotWebPageByEventResponseTupleSchemeFactory());
  }

  public long logid; // required
  public int totalNum; // required
  public List<HotWebPageContent> webpages; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.WEBPAGES, new org.apache.thrift.meta_data.FieldMetaData("webpages", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, HotWebPageContent.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryHotWebPageByEventResponse.class, metaDataMap);
  }

  public QueryHotWebPageByEventResponse() {
    this.logid = 1001L;
  ...
  public QueryHotWebPageByEventResponse(
    long logid,
    int totalNum,
    List<HotWebPageContent> webpages)
  {
    this();
    this.logid = logid;
    setLogidIsSet(true);
   ...
   */
  public QueryHotWebPageByEventResponse(QueryHotWebPageByEventResponse other) {
    __isset_bitfield = other.__isset_bitfield;
    this.logid = other.logid;
    this.totalNum = other.totalNum;
    if (other.isSetWebpages()) {
      List<HotWebPageContent> __this__webpages = new ArrayList<HotWebPageContent>();
      for (HotWebPageContent other_element : other.webpages) {
        __this__webpages.add(new HotWebPageContent(other_element));
      }
      this.webpages = __this__webpages;
    }
  }

  public QueryHotWebPageByEventResponse deepCopy() {
    return new QueryHotWebPageByEventResponse(this);
  }
  ...
  public QueryHotWebPageByEventResponse setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public QueryHotWebPageByEventResponse setTotalNum(int totalNum) {
    this.totalNum = totalNum;
    setTotalNumIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<HotWebPageContent> getWebpagesIterator() {
    return (this.webpages == null) ? null : this.webpages.iterator();
  }

  public void addToWebpages(HotWebPageContent elem) {
    if (this.webpages == null) {
      this.webpages = new ArrayList<HotWebPageContent>();
    }
    this.webpages.add(elem);
  }

  public List<HotWebPageContent> getWebpages() {
    return this.webpages;
  }

  public QueryHotWebPageByEventResponse setWebpages(List<HotWebPageContent> webpages) {
    this.webpages = webpages;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case WEBPAGES:
      if (value == null) {
        ...
        setWebpages((List<HotWebPageContent>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryHotWebPageByEventResponse)
      return this.equals((QueryHotWebPageByEventResponse)that);
    return false;
  }

  public boolean equals(QueryHotWebPageByEventResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryHotWebPageByEventResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryHotWebPageByEventResponse typedOther = (QueryHotWebPageByEventResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryHotWebPageByEventResponse(");
    boolean first = true;
  ...
  private static class QueryHotWebPageByEventResponseStandardSchemeFactory implements SchemeFactory {
    public QueryHotWebPageByEventResponseStandardScheme getScheme() {
      return new QueryHotWebPageByEventResponseStandardScheme();
    }
  }

  private static class QueryHotWebPageByEventResponseStandardScheme extends StandardScheme<QueryHotWebPageByEventResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryHotWebPageByEventResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.webpages = new ArrayList<HotWebPageContent>(_list160.size);
                for (int _i161 = 0; _i161 < _list160.size; ++_i161)
                {
                  HotWebPageContent _elem162; // required
                  _elem162 = new HotWebPageContent();
                  _elem162.read(iprot);
                  struct.webpages.add(_elem162);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryHotWebPageByEventResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.webpages != null) {
        oprot.writeFieldBegin(WEBPAGES_FIELD_DESC);
        {
          ...
          for (HotWebPageContent _iter163 : struct.webpages)
          {
  ...
  private static class QueryHotWebPageByEventResponseTupleSchemeFactory implements SchemeFactory {
    public QueryHotWebPageByEventResponseTupleScheme getScheme() {
      return new QueryHotWebPageByEventResponseTupleScheme();
    }
  }

  private static class QueryHotWebPageByEventResponseTupleScheme extends TupleScheme<QueryHotWebPageByEventResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryHotWebPageByEventResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI64(struct.logid);
      oprot.writeI32(struct.totalNum);
      {
        oprot.writeI32(struct.webpages.size());
        for (HotWebPageContent _iter164 : struct.webpages)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryHotWebPageByEventResponse struct) throws org.apache.thrift.TException {
      ...
      struct.setTotalNumIsSet(true);
      {
        ...
        struct.webpages = new ArrayList<HotWebPageContent>(_list165.size);
        for (int _i166 = 0; _i166 < _list165.size; ++_i166)
        {
          HotWebPageContent _elem167; // required
          _elem167 = new HotWebPageContent();
          _elem167.read(iprot);
          struct.webpages.add(_elem167);
        }
      }
      struct.setWebpagesIsSet(true);
    }
