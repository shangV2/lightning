...
public class RemoveConsistentTopicRequest implements org.apache.thrift.TBase<RemoveConsistentTopicRequest, RemoveConsistentTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoveConsistentTopicRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new RemoveConsistentTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RemoveConsistentTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoveConsistentTopicRequest.class, metaDataMap);
  }

  public RemoveConsistentTopicRequest() {
   ...
   */
  public RemoveConsistentTopicRequest(RemoveConsistentTopicRequest other) {
  ...
  public RemoveConsistentTopicRequest deepCopy() {
    return new RemoveConsistentTopicRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public RemoveConsistentTopicRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public RemoveConsistentTopicRequest setTopicId(long topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof RemoveConsistentTopicRequest)
      return this.equals((RemoveConsistentTopicRequest)that);
    return false;
  }

  public boolean equals(RemoveConsistentTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(RemoveConsistentTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    RemoveConsistentTopicRequest typedOther = (RemoveConsistentTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RemoveConsistentTopicRequest(");
    boolean first = true;
  ...
  private static class RemoveConsistentTopicRequestStandardSchemeFactory implements SchemeFactory {
    public RemoveConsistentTopicRequestStandardScheme getScheme() {
      return new RemoveConsistentTopicRequestStandardScheme();
    }
  }

  private static class RemoveConsistentTopicRequestStandardScheme extends StandardScheme<RemoveConsistentTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoveConsistentTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoveConsistentTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RemoveConsistentTopicRequestTupleSchemeFactory implements SchemeFactory {
    public RemoveConsistentTopicRequestTupleScheme getScheme() {
      return new RemoveConsistentTopicRequestTupleScheme();
    }
  }

  private static class RemoveConsistentTopicRequestTupleScheme extends TupleScheme<RemoveConsistentTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoveConsistentTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoveConsistentTopicRequest struct) throws org.apache.thrift.TException {
