...
public class ListShortMessageForTopicRequest implements org.apache.thrift.TBase<ListShortMessageForTopicRequest, ListShortMessageForTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ListShortMessageForTopicRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ListShortMessageForTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ListShortMessageForTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ListShortMessageForTopicRequest.class, metaDataMap);
  }

  public ListShortMessageForTopicRequest() {
   ...
   */
  public ListShortMessageForTopicRequest(ListShortMessageForTopicRequest other) {
  ...
  public ListShortMessageForTopicRequest deepCopy() {
    return new ListShortMessageForTopicRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public ListShortMessageForTopicRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public ListShortMessageForTopicRequest setTopicId(long topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public ListShortMessageForTopicRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public ListShortMessageForTopicRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListShortMessageForTopicRequest)
      return this.equals((ListShortMessageForTopicRequest)that);
    return false;
  }

  public boolean equals(ListShortMessageForTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ListShortMessageForTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ListShortMessageForTopicRequest typedOther = (ListShortMessageForTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ListShortMessageForTopicRequest(");
    boolean first = true;
  ...
  private static class ListShortMessageForTopicRequestStandardSchemeFactory implements SchemeFactory {
    public ListShortMessageForTopicRequestStandardScheme getScheme() {
      return new ListShortMessageForTopicRequestStandardScheme();
    }
  }

  private static class ListShortMessageForTopicRequestStandardScheme extends StandardScheme<ListShortMessageForTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ListShortMessageForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListShortMessageForTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ListShortMessageForTopicRequestTupleSchemeFactory implements SchemeFactory {
    public ListShortMessageForTopicRequestTupleScheme getScheme() {
      return new ListShortMessageForTopicRequestTupleScheme();
    }
  }

  private static class ListShortMessageForTopicRequestTupleScheme extends TupleScheme<ListShortMessageForTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ListShortMessageForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ListShortMessageForTopicRequest struct) throws org.apache.thrift.TException {
