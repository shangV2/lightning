...
public class QueryWebPageTrendForTopicRequest implements org.apache.thrift.TBase<QueryWebPageTrendForTopicRequest, QueryWebPageTrendForTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryWebPageTrendForTopicRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryWebPageTrendForTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryWebPageTrendForTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryWebPageTrendForTopicRequest.class, metaDataMap);
  }

  public QueryWebPageTrendForTopicRequest() {
   ...
   */
  public QueryWebPageTrendForTopicRequest(QueryWebPageTrendForTopicRequest other) {
  ...
  public QueryWebPageTrendForTopicRequest deepCopy() {
    return new QueryWebPageTrendForTopicRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public QueryWebPageTrendForTopicRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public QueryWebPageTrendForTopicRequest setTopicId(long topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryWebPageTrendForTopicRequest)
      return this.equals((QueryWebPageTrendForTopicRequest)that);
    return false;
  }

  public boolean equals(QueryWebPageTrendForTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryWebPageTrendForTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryWebPageTrendForTopicRequest typedOther = (QueryWebPageTrendForTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryWebPageTrendForTopicRequest(");
    boolean first = true;
  ...
  private static class QueryWebPageTrendForTopicRequestStandardSchemeFactory implements SchemeFactory {
    public QueryWebPageTrendForTopicRequestStandardScheme getScheme() {
      return new QueryWebPageTrendForTopicRequestStandardScheme();
    }
  }

  private static class QueryWebPageTrendForTopicRequestStandardScheme extends StandardScheme<QueryWebPageTrendForTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryWebPageTrendForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryWebPageTrendForTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class QueryWebPageTrendForTopicRequestTupleSchemeFactory implements SchemeFactory {
    public QueryWebPageTrendForTopicRequestTupleScheme getScheme() {
      return new QueryWebPageTrendForTopicRequestTupleScheme();
    }
  }

  private static class QueryWebPageTrendForTopicRequestTupleScheme extends TupleScheme<QueryWebPageTrendForTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryWebPageTrendForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryWebPageTrendForTopicRequest struct) throws org.apache.thrift.TException {
