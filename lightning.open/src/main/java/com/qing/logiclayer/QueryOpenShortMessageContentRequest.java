...
public class QueryOpenShortMessageContentRequest implements org.apache.thrift.TBase<QueryOpenShortMessageContentRequest, QueryOpenShortMessageContentRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryOpenShortMessageContentRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryOpenShortMessageContentRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryOpenShortMessageContentRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryOpenShortMessageContentRequest.class, metaDataMap);
  }

  public QueryOpenShortMessageContentRequest() {
   ...
   */
  public QueryOpenShortMessageContentRequest(QueryOpenShortMessageContentRequest other) {
  ...
  public QueryOpenShortMessageContentRequest deepCopy() {
    return new QueryOpenShortMessageContentRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public QueryOpenShortMessageContentRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public QueryOpenShortMessageContentRequest setQuery(String query) {
    this.query = query;
    return this;
  }
  ...
  public QueryOpenShortMessageContentRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public QueryOpenShortMessageContentRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public QueryOpenShortMessageContentRequest setSummaryLength(int summaryLength) {
    this.summaryLength = summaryLength;
    setSummaryLengthIsSet(true);
    return this;
  }
   ...
   * @see OpenCommonHighlight
   */
  public QueryOpenShortMessageContentRequest setHightlight(OpenCommonHighlight hightlight) {
    this.hightlight = hightlight;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryOpenShortMessageContentRequest)
      return this.equals((QueryOpenShortMessageContentRequest)that);
    return false;
  }

  public boolean equals(QueryOpenShortMessageContentRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryOpenShortMessageContentRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryOpenShortMessageContentRequest typedOther = (QueryOpenShortMessageContentRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryOpenShortMessageContentRequest(");
    boolean first = true;
  ...
  private static class QueryOpenShortMessageContentRequestStandardSchemeFactory implements SchemeFactory {
    public QueryOpenShortMessageContentRequestStandardScheme getScheme() {
      return new QueryOpenShortMessageContentRequestStandardScheme();
    }
  }

  private static class QueryOpenShortMessageContentRequestStandardScheme extends StandardScheme<QueryOpenShortMessageContentRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryOpenShortMessageContentRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryOpenShortMessageContentRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class QueryOpenShortMessageContentRequestTupleSchemeFactory implements SchemeFactory {
    public QueryOpenShortMessageContentRequestTupleScheme getScheme() {
      return new QueryOpenShortMessageContentRequestTupleScheme();
    }
  }

  private static class QueryOpenShortMessageContentRequestTupleScheme extends TupleScheme<QueryOpenShortMessageContentRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryOpenShortMessageContentRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryOpenShortMessageContentRequest struct) throws org.apache.thrift.TException {
