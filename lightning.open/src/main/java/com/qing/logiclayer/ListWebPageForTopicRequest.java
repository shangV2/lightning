...
public class ListWebPageForTopicRequest implements org.apache.thrift.TBase<ListWebPageForTopicRequest, ListWebPageForTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ListWebPageForTopicRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ListWebPageForTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ListWebPageForTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ListWebPageForTopicRequest.class, metaDataMap);
  }

  public ListWebPageForTopicRequest() {
   ...
   */
  public ListWebPageForTopicRequest(ListWebPageForTopicRequest other) {
  ...
  public ListWebPageForTopicRequest deepCopy() {
    return new ListWebPageForTopicRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public ListWebPageForTopicRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public ListWebPageForTopicRequest setTopicId(long topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public ListWebPageForTopicRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public ListWebPageForTopicRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListWebPageForTopicRequest)
      return this.equals((ListWebPageForTopicRequest)that);
    return false;
  }

  public boolean equals(ListWebPageForTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ListWebPageForTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ListWebPageForTopicRequest typedOther = (ListWebPageForTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ListWebPageForTopicRequest(");
    boolean first = true;
  ...
  private static class ListWebPageForTopicRequestStandardSchemeFactory implements SchemeFactory {
    public ListWebPageForTopicRequestStandardScheme getScheme() {
      return new ListWebPageForTopicRequestStandardScheme();
    }
  }

  private static class ListWebPageForTopicRequestStandardScheme extends StandardScheme<ListWebPageForTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ListWebPageForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListWebPageForTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ListWebPageForTopicRequestTupleSchemeFactory implements SchemeFactory {
    public ListWebPageForTopicRequestTupleScheme getScheme() {
      return new ListWebPageForTopicRequestTupleScheme();
    }
  }

  private static class ListWebPageForTopicRequestTupleScheme extends TupleScheme<ListWebPageForTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ListWebPageForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ListWebPageForTopicRequest struct) throws org.apache.thrift.TException {
