...
public class QueryOpenShortMessageContentResponse implements org.apache.thrift.TBase<QueryOpenShortMessageContentResponse, QueryOpenShortMessageContentResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryOpenShortMessageContentResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryOpenShortMessageContentResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryOpenShortMessageContentResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryOpenShortMessageContentResponse.class, metaDataMap);
  }

  public QueryOpenShortMessageContentResponse() {
    this.logid = 1001L;
   ...
   */
  public QueryOpenShortMessageContentResponse(QueryOpenShortMessageContentResponse other) {
  ...
  public QueryOpenShortMessageContentResponse deepCopy() {
    return new QueryOpenShortMessageContentResponse(this);
  }
  ...
  public QueryOpenShortMessageContentResponse setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public QueryOpenShortMessageContentResponse setTotalNum(int totalNum) {
    this.totalNum = totalNum;
    setTotalNumIsSet(true);
    return this;
  }
  ...
  public QueryOpenShortMessageContentResponse setShortmessages(List<OpenShortMessageContent> shortmessages) {
    this.shortmessages = shortmessages;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryOpenShortMessageContentResponse)
      return this.equals((QueryOpenShortMessageContentResponse)that);
    return false;
  }

  public boolean equals(QueryOpenShortMessageContentResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryOpenShortMessageContentResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryOpenShortMessageContentResponse typedOther = (QueryOpenShortMessageContentResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryOpenShortMessageContentResponse(");
    boolean first = true;
  ...
  private static class QueryOpenShortMessageContentResponseStandardSchemeFactory implements SchemeFactory {
    public QueryOpenShortMessageContentResponseStandardScheme getScheme() {
      return new QueryOpenShortMessageContentResponseStandardScheme();
    }
  }

  private static class QueryOpenShortMessageContentResponseStandardScheme extends StandardScheme<QueryOpenShortMessageContentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryOpenShortMessageContentResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.shortmessages = new ArrayList<OpenShortMessageContent>(_list32.size);
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  OpenShortMessageContent _elem34; // required
                  _elem34 = new OpenShortMessageContent();
                  _elem34.read(iprot);
                  struct.shortmessages.add(_elem34);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryOpenShortMessageContentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.shortmessages != null) {
        oprot.writeFieldBegin(SHORTMESSAGES_FIELD_DESC);
        {
          ...
          for (OpenShortMessageContent _iter35 : struct.shortmessages)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class QueryOpenShortMessageContentResponseTupleSchemeFactory implements SchemeFactory {
    public QueryOpenShortMessageContentResponseTupleScheme getScheme() {
      return new QueryOpenShortMessageContentResponseTupleScheme();
    }
  }

  private static class QueryOpenShortMessageContentResponseTupleScheme extends TupleScheme<QueryOpenShortMessageContentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryOpenShortMessageContentResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI64(struct.logid);
      oprot.writeI32(struct.totalNum);
      {
        oprot.writeI32(struct.shortmessages.size());
        for (OpenShortMessageContent _iter36 : struct.shortmessages)
        {
          _iter36.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryOpenShortMessageContentResponse struct) throws org.apache.thrift.TException {
      ...
      struct.setTotalNumIsSet(true);
      {
        ...
        struct.shortmessages = new ArrayList<OpenShortMessageContent>(_list37.size);
        for (int _i38 = 0; _i38 < _list37.size; ++_i38)
        {
          OpenShortMessageContent _elem39; // required
          _elem39 = new OpenShortMessageContent();
          _elem39.read(iprot);
          struct.shortmessages.add(_elem39);
        }
      }
      struct.setShortmessagesIsSet(true);
    }
