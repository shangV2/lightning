...
public class QueryShortMessageTrendForTopicRequest implements org.apache.thrift.TBase<QueryShortMessageTrendForTopicRequest, QueryShortMessageTrendForTopicRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryShortMessageTrendForTopicRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryShortMessageTrendForTopicRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryShortMessageTrendForTopicRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryShortMessageTrendForTopicRequest.class, metaDataMap);
  }

  public QueryShortMessageTrendForTopicRequest() {
   ...
   */
  public QueryShortMessageTrendForTopicRequest(QueryShortMessageTrendForTopicRequest other) {
  ...
  public QueryShortMessageTrendForTopicRequest deepCopy() {
    return new QueryShortMessageTrendForTopicRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public QueryShortMessageTrendForTopicRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public QueryShortMessageTrendForTopicRequest setTopicId(long topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryShortMessageTrendForTopicRequest)
      return this.equals((QueryShortMessageTrendForTopicRequest)that);
    return false;
  }

  public boolean equals(QueryShortMessageTrendForTopicRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryShortMessageTrendForTopicRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryShortMessageTrendForTopicRequest typedOther = (QueryShortMessageTrendForTopicRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryShortMessageTrendForTopicRequest(");
    boolean first = true;
  ...
  private static class QueryShortMessageTrendForTopicRequestStandardSchemeFactory implements SchemeFactory {
    public QueryShortMessageTrendForTopicRequestStandardScheme getScheme() {
      return new QueryShortMessageTrendForTopicRequestStandardScheme();
    }
  }

  private static class QueryShortMessageTrendForTopicRequestStandardScheme extends StandardScheme<QueryShortMessageTrendForTopicRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryShortMessageTrendForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryShortMessageTrendForTopicRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class QueryShortMessageTrendForTopicRequestTupleSchemeFactory implements SchemeFactory {
    public QueryShortMessageTrendForTopicRequestTupleScheme getScheme() {
      return new QueryShortMessageTrendForTopicRequestTupleScheme();
    }
  }

  private static class QueryShortMessageTrendForTopicRequestTupleScheme extends TupleScheme<QueryShortMessageTrendForTopicRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryShortMessageTrendForTopicRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryShortMessageTrendForTopicRequest struct) throws org.apache.thrift.TException {
