...
public class QueryShortMessageForTopicAtTimestampResponse implements org.apache.thrift.TBase<QueryShortMessageForTopicAtTimestampResponse, QueryShortMessageForTopicAtTimestampResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryShortMessageForTopicAtTimestampResponse");
  ...
  private static final org.apache.thrift.protocol.TField SHORTMESSAGES_FIELD_DESC = new org.apache.thrift.protocol.TField("shortmessages", org.apache.thrift.protocol.TType.LIST, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new QueryShortMessageForTopicAtTimestampResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryShortMessageForTopicAtTimestampResponseTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    LOGID((short)1, "logid"),
    SHORTMESSAGES((short)2, "shortmessages");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryShortMessageForTopicAtTimestampResponse.class, metaDataMap);
  }

  public QueryShortMessageForTopicAtTimestampResponse() {
    this.logid = 1001L;
   ...
   */
  public QueryShortMessageForTopicAtTimestampResponse(QueryShortMessageForTopicAtTimestampResponse other) {
  ...
  public QueryShortMessageForTopicAtTimestampResponse deepCopy() {
    return new QueryShortMessageForTopicAtTimestampResponse(this);
  }
  ...
  public QueryShortMessageForTopicAtTimestampResponse setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public QueryShortMessageForTopicAtTimestampResponse setShortmessages(List<OpenShortMessageContent> shortmessages) {
    this.shortmessages = shortmessages;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryShortMessageForTopicAtTimestampResponse)
      return this.equals((QueryShortMessageForTopicAtTimestampResponse)that);
    return false;
  }

  public boolean equals(QueryShortMessageForTopicAtTimestampResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryShortMessageForTopicAtTimestampResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryShortMessageForTopicAtTimestampResponse typedOther = (QueryShortMessageForTopicAtTimestampResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryShortMessageForTopicAtTimestampResponse(");
    boolean first = true;
  ...
  private static class QueryShortMessageForTopicAtTimestampResponseStandardSchemeFactory implements SchemeFactory {
    public QueryShortMessageForTopicAtTimestampResponseStandardScheme getScheme() {
      return new QueryShortMessageForTopicAtTimestampResponseStandardScheme();
    }
  }

  private static class QueryShortMessageForTopicAtTimestampResponseStandardScheme extends StandardScheme<QueryShortMessageForTopicAtTimestampResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryShortMessageForTopicAtTimestampResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.shortmessages = new ArrayList<OpenShortMessageContent>(_list120.size);
                for (int _i121 = 0; _i121 < _list120.size; ++_i121)
                {
                  OpenShortMessageContent _elem122; // required
                  _elem122 = new OpenShortMessageContent();
                  _elem122.read(iprot);
                  struct.shortmessages.add(_elem122);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryShortMessageForTopicAtTimestampResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.shortmessages != null) {
        oprot.writeFieldBegin(SHORTMESSAGES_FIELD_DESC);
        {
          ...
          for (OpenShortMessageContent _iter123 : struct.shortmessages)
          {
  ...
  private static class QueryShortMessageForTopicAtTimestampResponseTupleSchemeFactory implements SchemeFactory {
    public QueryShortMessageForTopicAtTimestampResponseTupleScheme getScheme() {
      return new QueryShortMessageForTopicAtTimestampResponseTupleScheme();
    }
  }

  private static class QueryShortMessageForTopicAtTimestampResponseTupleScheme extends TupleScheme<QueryShortMessageForTopicAtTimestampResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryShortMessageForTopicAtTimestampResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI64(struct.logid);
      {
        oprot.writeI32(struct.shortmessages.size());
        for (OpenShortMessageContent _iter124 : struct.shortmessages)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryShortMessageForTopicAtTimestampResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      struct.logid = iprot.readI64();
      struct.setLogidIsSet(true);
      {
        org.apache.thrift.protocol.TList _list125 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.shortmessages = new ArrayList<OpenShortMessageContent>(_list125.size);
        for (int _i126 = 0; _i126 < _list125.size; ++_i126)
        {
          OpenShortMessageContent _elem127; // required
          _elem127 = new OpenShortMessageContent();
          _elem127.read(iprot);
          struct.shortmessages.add(_elem127);
        }
      }
      struct.setShortmessagesIsSet(true);
    }
