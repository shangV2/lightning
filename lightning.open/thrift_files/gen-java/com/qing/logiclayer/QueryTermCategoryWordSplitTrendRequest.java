...
public class QueryTermCategoryWordSplitTrendRequest implements org.apache.thrift.TBase<QueryTermCategoryWordSplitTrendRequest, QueryTermCategoryWordSplitTrendRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryTermCategoryWordSplitTrendRequest");
  ...
  private static final org.apache.thrift.protocol.TField STARTDATE_FIELD_DESC = new org.apache.thrift.protocol.TField("startdate", org.apache.thrift.protocol.TType.STRING, (short)4);
  private static final org.apache.thrift.protocol.TField ENDDATE_FIELD_DESC = new org.apache.thrift.protocol.TField("enddate", org.apache.thrift.protocol.TType.STRING, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new QueryTermCategoryWordSplitTrendRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryTermCategoryWordSplitTrendRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryTermCategoryWordSplitTrendRequest.class, metaDataMap);
  }

  public QueryTermCategoryWordSplitTrendRequest() {
   ...
   */
  public QueryTermCategoryWordSplitTrendRequest(QueryTermCategoryWordSplitTrendRequest other) {
  ...
  public QueryTermCategoryWordSplitTrendRequest deepCopy() {
    return new QueryTermCategoryWordSplitTrendRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public QueryTermCategoryWordSplitTrendRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
   ...
   * @see TermCategoryType
   */
  public QueryTermCategoryWordSplitTrendRequest setTctype(TermCategoryType tctype) {
    this.tctype = tctype;
    return this;
  }
  ...
  public QueryTermCategoryWordSplitTrendRequest setWord(String word) {
    this.word = word;
    return this;
  }
  ...
  public QueryTermCategoryWordSplitTrendRequest setStartdate(String startdate) {
    this.startdate = startdate;
    return this;
  }
  ...
  public QueryTermCategoryWordSplitTrendRequest setEnddate(String enddate) {
    this.enddate = enddate;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryTermCategoryWordSplitTrendRequest)
      return this.equals((QueryTermCategoryWordSplitTrendRequest)that);
    return false;
  }

  public boolean equals(QueryTermCategoryWordSplitTrendRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryTermCategoryWordSplitTrendRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryTermCategoryWordSplitTrendRequest typedOther = (QueryTermCategoryWordSplitTrendRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryTermCategoryWordSplitTrendRequest(");
    boolean first = true;
  ...
  private static class QueryTermCategoryWordSplitTrendRequestStandardSchemeFactory implements SchemeFactory {
    public QueryTermCategoryWordSplitTrendRequestStandardScheme getScheme() {
      return new QueryTermCategoryWordSplitTrendRequestStandardScheme();
    }
  }

  private static class QueryTermCategoryWordSplitTrendRequestStandardScheme extends StandardScheme<QueryTermCategoryWordSplitTrendRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryTermCategoryWordSplitTrendRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryTermCategoryWordSplitTrendRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class QueryTermCategoryWordSplitTrendRequestTupleSchemeFactory implements SchemeFactory {
    public QueryTermCategoryWordSplitTrendRequestTupleScheme getScheme() {
      return new QueryTermCategoryWordSplitTrendRequestTupleScheme();
    }
  }

  private static class QueryTermCategoryWordSplitTrendRequestTupleScheme extends TupleScheme<QueryTermCategoryWordSplitTrendRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryTermCategoryWordSplitTrendRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryTermCategoryWordSplitTrendRequest struct) throws org.apache.thrift.TException {
