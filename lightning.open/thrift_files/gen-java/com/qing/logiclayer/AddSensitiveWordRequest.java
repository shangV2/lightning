...
public class AddSensitiveWordRequest implements org.apache.thrift.TBase<AddSensitiveWordRequest, AddSensitiveWordRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddSensitiveWordRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new AddSensitiveWordRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddSensitiveWordRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddSensitiveWordRequest.class, metaDataMap);
  }

  public AddSensitiveWordRequest() {
   ...
   */
  public AddSensitiveWordRequest(AddSensitiveWordRequest other) {
  ...
  public AddSensitiveWordRequest deepCopy() {
    return new AddSensitiveWordRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public AddSensitiveWordRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public AddSensitiveWordRequest setWord(String word) {
    this.word = word;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddSensitiveWordRequest)
      return this.equals((AddSensitiveWordRequest)that);
    return false;
  }

  public boolean equals(AddSensitiveWordRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(AddSensitiveWordRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    AddSensitiveWordRequest typedOther = (AddSensitiveWordRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddSensitiveWordRequest(");
    boolean first = true;
  ...
  private static class AddSensitiveWordRequestStandardSchemeFactory implements SchemeFactory {
    public AddSensitiveWordRequestStandardScheme getScheme() {
      return new AddSensitiveWordRequestStandardScheme();
    }
  }

  private static class AddSensitiveWordRequestStandardScheme extends StandardScheme<AddSensitiveWordRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddSensitiveWordRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddSensitiveWordRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AddSensitiveWordRequestTupleSchemeFactory implements SchemeFactory {
    public AddSensitiveWordRequestTupleScheme getScheme() {
      return new AddSensitiveWordRequestTupleScheme();
    }
  }

  private static class AddSensitiveWordRequestTupleScheme extends TupleScheme<AddSensitiveWordRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddSensitiveWordRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddSensitiveWordRequest struct) throws org.apache.thrift.TException {
