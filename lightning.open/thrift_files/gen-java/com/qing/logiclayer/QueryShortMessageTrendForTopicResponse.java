...
public class QueryShortMessageTrendForTopicResponse implements org.apache.thrift.TBase<QueryShortMessageTrendForTopicResponse, QueryShortMessageTrendForTopicResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryShortMessageTrendForTopicResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryShortMessageTrendForTopicResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryShortMessageTrendForTopicResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryShortMessageTrendForTopicResponse.class, metaDataMap);
  }

  public QueryShortMessageTrendForTopicResponse() {
    this.logid = 1001L;
   ...
   */
  public QueryShortMessageTrendForTopicResponse(QueryShortMessageTrendForTopicResponse other) {
  ...
  public QueryShortMessageTrendForTopicResponse deepCopy() {
    return new QueryShortMessageTrendForTopicResponse(this);
  }
  ...
  public QueryShortMessageTrendForTopicResponse setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public QueryShortMessageTrendForTopicResponse setTrends(List<DateNumberTopicTrend> trends) {
    this.trends = trends;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryShortMessageTrendForTopicResponse)
      return this.equals((QueryShortMessageTrendForTopicResponse)that);
    return false;
  }

  public boolean equals(QueryShortMessageTrendForTopicResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryShortMessageTrendForTopicResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryShortMessageTrendForTopicResponse typedOther = (QueryShortMessageTrendForTopicResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryShortMessageTrendForTopicResponse(");
    boolean first = true;
  ...
  private static class QueryShortMessageTrendForTopicResponseStandardSchemeFactory implements SchemeFactory {
    public QueryShortMessageTrendForTopicResponseStandardScheme getScheme() {
      return new QueryShortMessageTrendForTopicResponseStandardScheme();
    }
  }

  private static class QueryShortMessageTrendForTopicResponseStandardScheme extends StandardScheme<QueryShortMessageTrendForTopicResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryShortMessageTrendForTopicResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.trends = new ArrayList<DateNumberTopicTrend>(_list112.size);
                for (int _i113 = 0; _i113 < _list112.size; ++_i113)
                {
                  DateNumberTopicTrend _elem114; // required
                  _elem114 = new DateNumberTopicTrend();
                  _elem114.read(iprot);
                  struct.trends.add(_elem114);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryShortMessageTrendForTopicResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.trends != null) {
        oprot.writeFieldBegin(TRENDS_FIELD_DESC);
        {
          ...
          for (DateNumberTopicTrend _iter115 : struct.trends)
          {
  ...
  private static class QueryShortMessageTrendForTopicResponseTupleSchemeFactory implements SchemeFactory {
    public QueryShortMessageTrendForTopicResponseTupleScheme getScheme() {
      return new QueryShortMessageTrendForTopicResponseTupleScheme();
    }
  }

  private static class QueryShortMessageTrendForTopicResponseTupleScheme extends TupleScheme<QueryShortMessageTrendForTopicResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryShortMessageTrendForTopicResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI64(struct.logid);
      {
        oprot.writeI32(struct.trends.size());
        for (DateNumberTopicTrend _iter116 : struct.trends)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryShortMessageTrendForTopicResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      struct.logid = iprot.readI64();
      struct.setLogidIsSet(true);
      {
        org.apache.thrift.protocol.TList _list117 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.trends = new ArrayList<DateNumberTopicTrend>(_list117.size);
        for (int _i118 = 0; _i118 < _list117.size; ++_i118)
        {
          DateNumberTopicTrend _elem119; // required
          _elem119 = new DateNumberTopicTrend();
          _elem119.read(iprot);
          struct.trends.add(_elem119);
        }
      }
      struct.setTrendsIsSet(true);
    }
