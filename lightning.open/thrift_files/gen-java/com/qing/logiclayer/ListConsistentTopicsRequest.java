...
public class ListConsistentTopicsRequest implements org.apache.thrift.TBase<ListConsistentTopicsRequest, ListConsistentTopicsRequest._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ListConsistentTopicsRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ListConsistentTopicsRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ListConsistentTopicsRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ListConsistentTopicsRequest.class, metaDataMap);
  }

  public ListConsistentTopicsRequest() {
   ...
   */
  public ListConsistentTopicsRequest(ListConsistentTopicsRequest other) {
  ...
  public ListConsistentTopicsRequest deepCopy() {
    return new ListConsistentTopicsRequest(this);
  }
   ...
   * @see OpenCommonLanguge
   */
  public ListConsistentTopicsRequest setLangugeType(OpenCommonLanguge langugeType) {
    this.langugeType = langugeType;
    return this;
  }
  ...
  public ListConsistentTopicsRequest setPageno(int pageno) {
    this.pageno = pageno;
    setPagenoIsSet(true);
    return this;
  }
  ...
  public ListConsistentTopicsRequest setPagesize(int pagesize) {
    this.pagesize = pagesize;
    setPagesizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ListConsistentTopicsRequest)
      return this.equals((ListConsistentTopicsRequest)that);
    return false;
  }

  public boolean equals(ListConsistentTopicsRequest that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ListConsistentTopicsRequest other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ListConsistentTopicsRequest typedOther = (ListConsistentTopicsRequest)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ListConsistentTopicsRequest(");
    boolean first = true;
  ...
  private static class ListConsistentTopicsRequestStandardSchemeFactory implements SchemeFactory {
    public ListConsistentTopicsRequestStandardScheme getScheme() {
      return new ListConsistentTopicsRequestStandardScheme();
    }
  }

  private static class ListConsistentTopicsRequestStandardScheme extends StandardScheme<ListConsistentTopicsRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ListConsistentTopicsRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ListConsistentTopicsRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ListConsistentTopicsRequestTupleSchemeFactory implements SchemeFactory {
    public ListConsistentTopicsRequestTupleScheme getScheme() {
      return new ListConsistentTopicsRequestTupleScheme();
    }
  }

  private static class ListConsistentTopicsRequestTupleScheme extends TupleScheme<ListConsistentTopicsRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ListConsistentTopicsRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ListConsistentTopicsRequest struct) throws org.apache.thrift.TException {
