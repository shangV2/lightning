...
public class QueryOpenWebPageWithTimeResponse implements org.apache.thrift.TBase<QueryOpenWebPageWithTimeResponse, QueryOpenWebPageWithTimeResponse._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryOpenWebPageWithTimeResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryOpenWebPageWithTimeResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryOpenWebPageWithTimeResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryOpenWebPageWithTimeResponse.class, metaDataMap);
  }

  public QueryOpenWebPageWithTimeResponse() {
    this.logid = 1001L;
   ...
   */
  public QueryOpenWebPageWithTimeResponse(QueryOpenWebPageWithTimeResponse other) {
  ...
  public QueryOpenWebPageWithTimeResponse deepCopy() {
    return new QueryOpenWebPageWithTimeResponse(this);
  }
  ...
  public QueryOpenWebPageWithTimeResponse setLogid(long logid) {
    this.logid = logid;
    setLogidIsSet(true);
    return this;
  }
  ...
  public QueryOpenWebPageWithTimeResponse setTotalNum(int totalNum) {
    this.totalNum = totalNum;
    setTotalNumIsSet(true);
    return this;
  }
  ...
  public QueryOpenWebPageWithTimeResponse setWebpages(List<OpenWebPageContent> webpages) {
    this.webpages = webpages;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryOpenWebPageWithTimeResponse)
      return this.equals((QueryOpenWebPageWithTimeResponse)that);
    return false;
  }

  public boolean equals(QueryOpenWebPageWithTimeResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryOpenWebPageWithTimeResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryOpenWebPageWithTimeResponse typedOther = (QueryOpenWebPageWithTimeResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QueryOpenWebPageWithTimeResponse(");
    boolean first = true;
  ...
  private static class QueryOpenWebPageWithTimeResponseStandardSchemeFactory implements SchemeFactory {
    public QueryOpenWebPageWithTimeResponseStandardScheme getScheme() {
      return new QueryOpenWebPageWithTimeResponseStandardScheme();
    }
  }

  private static class QueryOpenWebPageWithTimeResponseStandardScheme extends StandardScheme<QueryOpenWebPageWithTimeResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryOpenWebPageWithTimeResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.webpages = new ArrayList<OpenWebPageContent>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  OpenWebPageContent _elem26; // required
                  _elem26 = new OpenWebPageContent();
                  _elem26.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryOpenWebPageWithTimeResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.webpages != null) {
        oprot.writeFieldBegin(WEBPAGES_FIELD_DESC);
        {
          ...
          for (OpenWebPageContent _iter27 : struct.webpages)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class QueryOpenWebPageWithTimeResponseTupleSchemeFactory implements SchemeFactory {
    public QueryOpenWebPageWithTimeResponseTupleScheme getScheme() {
      return new QueryOpenWebPageWithTimeResponseTupleScheme();
    }
  }

  private static class QueryOpenWebPageWithTimeResponseTupleScheme extends TupleScheme<QueryOpenWebPageWithTimeResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryOpenWebPageWithTimeResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetWebpages()) {
        {
          ...
          for (OpenWebPageContent _iter28 : struct.webpages)
          {
            _iter28.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryOpenWebPageWithTimeResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.webpages = new ArrayList<OpenWebPageContent>(_list29.size);
          for (int _i30 = 0; _i30 < _list29.size; ++_i30)
          {
            OpenWebPageContent _elem31; // required
            _elem31 = new OpenWebPageContent();
            _elem31.read(iprot);
